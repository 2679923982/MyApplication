...
public class Main4Activity extends AppCompatActivity implements MediaPlayer.OnCompletionListener{
...
private String name, song_idBen, song_name;
private String findkBen;
...
//     //   HttpClient.getMusicDownloadInfo(song_idBen, new HttpCallback<DownloadInfo>() {
//
//@Override
//public void onSuccess(DownloadInfo downloadInfo) {
//  //  findkBen = downloadInfo.getBitrate().getFile_link();
//        playing();
//        isStart();
//
//        }
...
private void loadLrcData() {
        HttpClient.getLrc(song_idBen, new HttpCallback<MusicLrc>() {
@Override
...
private void initVIew() {
        ...
        song_idBen = intent.getStringExtra("songidBen");
        lodaData();
        loadLrcData();
...
public void setProessListen() {
    timer.schedule(new Main4Activity.Take(), 0, 1000);
...
public void isStart() {
        try {
        mediaPlayer.setDataSource(findkBen);
        mediaPlayer.prepare();
