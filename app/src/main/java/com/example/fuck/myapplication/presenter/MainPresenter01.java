...
public class MainPresenter01 extends BasePresenter implements HttpUtils.HttpUtilsCallback<TestBean>{
    ...
    public void loadDataFromServer() {
        ...
        httpUtils.loadData(this,"1",15,0,TestBean.class);
    ...
    public void callbackOK(TestBean testBean) {
        //做逻辑判断 回调数据
        iBaseView.onSuccess01(testBean,needClear);
        needClear = false;
    }
