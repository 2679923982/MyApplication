...
//        }
    ...
    public void onCreate() {
        ...
        musiclist = Fragment_mine.musicList;
         // 监听播放是否完成
...
//                curposition = (curposition) % musiclist.size();
    ...
    public void onSensorChanged(SensorEvent event) {
       if(Fragment_mine.sharedPreferences.getInt("play_accelerometer",0) == 0){
           // 传感器报告新的值
    ...
    private void playnew() {
        switch (Fragment_mine.sharedPreferences.getInt("play_mode",-1)){
            case 0://随机
...
//        //开启前台service
            ...
            if (Build.VERSION.SDK_INT < 16) {
                ...
                PendingIntent contentIntent = PendingIntent.getActivity(this, 0,
                        new Intent(this, Fragment_mine.class), 0);
